...
`front_pan`은 Ultra96의 `/home/xilinx/ultra_yubin_v1/front_center.env` 안의 `PAN=` 값 또는 PLPING/T/A 응답 기준값을 사용합니다. `0-4095` tick 전체를 `-90..+90` 범위처럼 변환하면 실제 모터 방향과 대시보드 방향이 맞지 않습니다.
...
6. 값이 없으면 fallback으로 `ptz.pan_deg`
